...
OUTDIR=/home/ccr-01/buenning/rtest03/rsm_runs/rsm_2010_ens01_00_month/${year}${mon}
take_end_stream=yes
dir=/home/ccr-01/buenning/rtest03/rsm_runs/rsm_2010_ens01_00/${year}${mon}
GRMEAN=/home/ccr-01/buenning/rtest03/libs/etc/grmean
INCHOUR=/home/ccr-01/buenning/rtest03/libs/etc/inchour
FORCE_GRIB_DATE_MON=/home/ccr-01/buenning/rtest03/libs/etc/force_grib_date_mon
#
...
#      do
	  ...
	  while [ $day -le $dayf ] ; do
	      ...
	      if [ ! -s r_pgb.$year$mon$dd.avrg.grib ] ; then
		  echo file pgb.$year$mon$dd.avrg.grib does not exist
		  exit 8
	      fi
	      echo r_pgb.$year$mon$dd.avrg.grib >>list.$$
              day=`expr $day + 1`
	  done
#
